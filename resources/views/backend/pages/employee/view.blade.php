                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly type="text" id="bangla-input"
                        ...
                        {{-- <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control @if ($errors->has('spouse_name1')) is-invalid @endif" placeholder="Enter Employee Spouse Name" wire:model="spouse_name1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Employee Spouse Name</label>
                                            <input readonly type="text"  class="form-control @if ($errors->has('spouse_name2')) is-invalid @endif" placeholder="Enter Employee Spouse Name" wire:model="spouse_name2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="date" class="form-control @if ($errors->has('date_of_birth')) is-invalid @endif" placeholder="Date Of Birth" wire:model="date_of_birth"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                    </div>
                                    <input readonly type="text" name="date_of_birth"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select disabled name="marital_status" id="maritalStatus"
                                    class="form-control select2 @if ($errors->has('marital_status')) is-invalid @endif">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {{-- <label for="exampleInputEmail1">Employee Signature</label>
                                            <input readonly type="file" class="form-control mb-1" id="formFile2" onChange="mainThamUrl2(this)" wire:model="employee_sign"> --}}
                                <label for="exampleInputFile">Police Verification (If Has)</label>
                                <div class="custom-file mb-2">
                                    <input readonly type="file" id="photoPathInput" name="employee_sign"
                    ...
                    <div class="card-body" id="child-info-container">
                        <div class="row">
                            ...
                            @empty($employee->getChildInfo[0])
                                <p class="col-md-12 text-center">Empty</p>
                            @endempty
                            ...
                            @foreach ($employee->getChildInfo as $child)
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{-- <input readonly type="date" class="form-control @if ($errors->has('childDateOfBirth')) is-invalid @endif" placeholder="Enter Birth Date Of Child" name="childDateOfBirth[]"> --}}
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                            </div>
                                ...
                                <div class="col-md-3" style="margin-top: 2rem!important;">
                                    <div class="form-group form-check" style="margin-left: 51px !important">
                                        <input readonly type="checkbox" id="checkboxSuccess1"
                                            {{ $child->educational_status ? 'checked' : '' }}>
                                        {{-- <input readonly type="checkbox" name="educational_status[]" class="form-check-input" id="exampleCheck1"> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{-- <input readonly type="text" class="form-control @if ($errors->has('child_name')) is-invalid @endif" placeholder="Training Name" name="child_name[]"> --}}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{-- <input readonly type="date" class="form-control @if ($errors->has('child_name')) is-invalid @endif" placeholder="Training Name" name="child_name[]"> --}}
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" name="mobile" value="{{ $employee->mobile }}"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="department_id" disabled
                                    ...
                                    @foreach ($departments as $department)
                                        <option {{ $employee->department_id == $department->id ? 'selected':''}}>{{ $department->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="designation_id" disabled
                                    class="form-control select2 @if ($errors->has('designation_id')) is-invalid @endif">
                                    <option>Select Designation</option>
                                    @foreach ($designations as $designation)
                                        <option {{ $employee->designation_id == $designation->id ? 'selected':''}}>{{ $designation->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="date"  class="form-control @if ($errors->has('date_of_join')) is-invalid @endif" wire:model="date_of_join"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                    </div>
                                    <input readonly type="text" name="date_of_join" class="form-control" value="{{ $employee->date_of_join }}"
                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="date" class="form-control @if ($errors->has('commission_date')) is-invalid @endif" wire:model="commission_date"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                    </div>
                                    <input readonly type="text" name="commission_date" class="form-control" value="{{ $employee->commission_date }}"
                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="date" class="form-control @if ($errors->has('promotion_date')) is-invalid @endif" wire:model="promotion_date"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                    </div>
                                    <input readonly type="text" name="promotion_date" class="form-control"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="text" class="form-control @if ($errors->has('telephone_office')) is-invalid @endif" placeholder="Telephone Of Office" wire:model="telephone_office"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                    </div>
                                    <input readonly type="text" name="telephone_office"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input readonly type="text" class="form-control @if ($errors->has('v')) is-invalid @endif" placeholder="Telephone Of Home" wire:model="telephone_home"> --}}
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly type="text" name="pbx" value="{{ $employee->pbx }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                {{-- <label for="exampleInputEmail1">Employee Photo</label>
                                                    <input readonly type="file" class="form-control mb-1" id="formFile" onChange="mainThamUrl(this)" name="employee_photo"> --}}
                                <label for="employee_photo">Employee Photo</label>
                                <div class="custom-file mb-2">
                                    <input readonly type="file" class="custom-file-input" name="employee_photo"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="custom-file mb-2">
                                    <input readonly type="file" name="employee_sign" class="custom-file-input"
